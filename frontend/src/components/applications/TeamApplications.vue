<template>
    <div class="team-applications">
      <div class="section-header">
        <h2><i class="fas fa-users"></i> Заявки на создание команд</h2>
        <div class="actions">
          ...
          <div class="application-main">
            ...
            <div class="application-meta">
              <div class="meta-item">
                ...
                <span>Лидер: {{ app.leaderName }}</span>
              </div>
              <div class="meta-item">
              ...
              <div class="meta-item">
                ...
                <span>Участников: {{ app.members.length }}</span>
              </div>
            </div>
            
            <div class="application-description">
              <p><strong>Цель создания команды:</strong> {{ app.purpose }}</p>
            </div>
            
            <div class="team-members" v-if="app.members.length > 0">
              <h4>Состав команды:</h4>
              <ul>
                <li v-for="(member, idx) in app.members" :key="idx">
...
const applications = ref([
  {
    ...
    leaderName: 'Соколов Артем',
    purpose: 'Создание команды для разработки современных веб-решений с использованием передовых технологий',
    members: [
      { name: 'Соколов Артем', role: 'Team Lead, Full-stack разработчик' },
      { name: 'Михайлова Ольга', role: 'Frontend разработчик' },
      { name: 'Никитин Игорь', role: 'Backend разработчик' },
      { name: 'Зайцева Екатерина', role: 'UI/UX дизайнер' }
    ],
    status: 'pending',
    statusLabel: 'На рассмотрении',
    createdAt: '2023-05-16T15:40:00Z'
  },
  {
    id: 2,
    teamName: 'Data Science Pro',
    leaderName: 'Гордеев Павел',
    purpose: 'Команда для реализации проектов в области анализа данных и машинного обучения',
    members: [
      { name: 'Гордеев Павел', role: 'Data Scientist' },
      { name: 'Белова Анастасия', role: 'Data Engineer' },
      { name: 'Крылов Максим', role: 'ML Engineer' }
    ],
    status: 'approved',
    statusLabel: 'Одобрена',
    createdAt: '2023-05-08T12:15:00Z',
    notes: 'Команда зарегистрирована, доступ к ресурсам предоставлен'
  }
]);
...
const loadApplications = async () => {
  loading.value = true;
  try {
    const response = await getApplications('teams');
